...
// Extended by simplymathematics 2018121 compiled on Ubuntu 18.08 using Arduino
...
void setup() {
  ...
  Serial.println(F("adapted for use in heatmapping by simplymathematics"));
